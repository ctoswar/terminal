...
#C:\Users\ctos1\AppData\Roaming\Microsoft\Windows\Recent\startship.toml.lnk
...
$ENV:STARSHIP_CONFIG = "C:\Users\ctos1\.config\starship.toml"
$ENV:STARSHIP_DISTRO = "ctos "
Invoke-Expression (& 'C:\Program Files\starship\bin\starship.exe' init powershell --print-full-init | Out-String)
